 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to=new I1("@firebase/auth");function Cp(n,...t){to.logLevel<=it.WARN&&to.warn(`Auth (${Ur}): ${n}`,...t)}function Hi(n,...t){to.logLevel<=it.ERROR&&to.error(`Auth (${Ur}): ${n}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Up(n,t){return nn(n,"POST","/v1/accounts:delete",t)}async function eo(n,t){return nn(n,"POST","/v1/accounts:lookup",t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function no(n){var m;const t=n.auth,e=await n.getIdToken(),r=await Cr(n,eo(t,{idToken:e}));Q(r==null?void 0:r.users.length,t,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(m=s.providerUserInfo)!=null&&m.length?c2(s.providerUserInfo):[],o=jp(n.providerData,i),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!(o!=null&&o.length),h=c?u:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new Ja(s.createdAt,s.lastLoginAt),isAnonymous:h};Object.assign(n,p)}async function Hp(n){const t=Tt(n);await no(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}function jp(n,t){return[...n.filter(r=>!t.some(s=>s.providerId===r.providerId)),...t]}function c2(n){return n.map(({providerId:t,...e})=>({providerId:t,uid:e.rawId||"",displayName:e.displayName||null,email:e.email||null,phoneNumber:e.phoneNumber||null,photoURL:e.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ji(n,t,e){return`firebase:${n}:${t}:${e}`}class Ar{constructor(t,e,r){this.persistence=t,this.auth=e,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=ji(this.userKey,s.apiKey,i),this.fullPersistenceKey=ji("persistence",s.apiKey,i),this.boundEventHandler=e._onStorageEvent.bind(e),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(t){return this.persistence._set(this.fullUserKey,t.toJSON())}async getCurrentUser(){const t=await this.persistence._get(this.fullUserKey);if(!t)return null;if(typeof t=="string"){const e=await eo(this.auth,{idToken:t}).catch(()=>{});return e?Ie._fromGetAccountInfoResponse(this.auth,e,t):null}return Ie._fromJSON(this.auth,t)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(t){if(this.persistence===t)return;const e=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=t,e)return this.setCurrentUser(e)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(t,e,r="authUser"){if(!e.length)return new Ar(He(Xu),t,r);const s=(await Promise.all(e.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let i=s[0]||He(Xu);const o=ji(r,t.config.apiKey,t.name);let c=null;for(const h of e)try{const p=await h._get(o);if(p){let m;if(typeof p=="string"){const T=await eo(t,{idToken:p}).catch(()=>{});if(!T)break;m=await Ie._fromGetAccountInfoResponse(t,T,p)}else m=Ie._fromJSON(t,p);h!==i&&(c=m),i=h;break}}catch{}const u=s.filter(h=>h._shouldAllowMigration);return!i._shouldAllowMigration||!u.length?new Ar(i,t,r):(i=u[0],c&&await i._set(o,c.toJSON()),await Promise.all(e.map(async h=>{if(h!==i)try{await h._remove(o)}catch{}})),new Ar(i,t,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro extends Be{constructor(t,e,r,s){super(e.code,e.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,ro.prototype),this.customData={appName:t.name,tenantId:t.tenantId??void 0,_serverResponse:e.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(t,e,r,s){return new ro(t,e,r,s)}}function I2(n,t,e,r){return(t==="reauthenticate"?e._getReauthenticationResolver(n):e._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?ro._fromErrorAndOperation(n,i,t,r):i})}async function w7(n,t,e=!1){const r=await Cr(n,t._linkToIdToken(n.auth,await n.getIdToken()),e);return rr._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class R2{constructor(t,e){this.storageRetriever=t,this.type=e}_isAvailable(){try{return this.storage?(this.storage.setItem(so,"1"),this.storage.removeItem(so),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(t,e){return this.storage.setItem(t,JSON.stringify(e)),Promise.resolve()}_get(t){const e=this.storage.getItem(t);return Promise.resolve(e?JSON.parse(e):null)}_remove(t){return this.storage.removeItem(t),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G7="pendingRedirect",Gi=new Map;class z7 extends x2{constructor(t,e,r=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],e,void 0,r),this.eventId=null}async execute(){let t=Gi.get(this.auth._key());if(!t){try{const r=await W7(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(r)}catch(e){t=()=>Promise.reject(e)}Gi.set(this.auth._key(),t)}return this.bypassAuthState||Gi.set(this.auth._key(),()=>Promise.resolve(null)),t()}async onAuthEvent(t){if(t.type==="signInViaRedirect")return super.onAuthEvent(t);if(t.type==="unknown"){this.resolve(null);return}if(t.eventId){const e=await this.auth._redirectUserForId(t.eventId);if(e)return this.user=e,super.onAuthEvent(t);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function W7(n,t){const e=Q7(t),r=Y7(n);if(!await r._isAvailable())return!1;const s=await r._get(e)==="true";return await r._remove(e),s}function K7(n,t){Gi.set(n._key(),t)}function Y7(n){return He(n._redirectPersistence)}function Q7(n){return ji(G7,n.config.apiKey,n.name)}async function X7(n,t,e=!1){if(ue(n.app))return Promise.reject(We(n));const r=Un(n),s=V2(r,t),o=await new z7(r,s,e).execute();return o&&!e&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,t)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class No{constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=r=>this.ae(r),this.ue=r=>e.writeSequenceNumber(r))}ae(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.ue&&this.ue(t),t}}No.ce=-1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Y2="server_timestamp",Q2="__type__",X2="__previous_value__",J2="__local_write_time__";function Oo(n){var e,r;return((r=(((e=n==null?void 0:n.mapValue)==null?void 0:e.fields)||{})[Q2])==null?void 0:r.stringValue)===Y2}function ui(n){const t=n.mapValue.fields[X2];return Oo(t)?ui(t):t}function br(n){const t=bn(n.mapValue.fields[J2].timestampValue);return new pt(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(n,t){if(n.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Bs(t)?"-0":t}}function M1(n){return{integerValue:""+n}}function ko(n,t,e){return Number.isInteger(t)&&(e!=null&&e.preferIntegers)||l3(t)?M1(t):Do(n,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(){this._=void 0}}function w3(n,t,e){return n instanceof js?(function(s,i){const o={fields:{[Q2]:{stringValue:Y2},[J2]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Oo(i)&&(i=ui(i)),i&&(o.fields[X2]=i),{mapValue:o}})(e,t):n instanceof kr?r6(n,t):n instanceof Vr?s6(n,t):n instanceof xr?(function(s,i){const o=n6(s,i),c=ho(o)+ho(s.Re);return Ne(o)&&Ne(s.Re)?M1(c):Do(s.serializer,c)})(n,t):n instanceof uo?(function(s,i){return Gl(s,i,Math.min)})(n,t):n instanceof lo?(function(s,i){return Gl(s,i,Math.max)})(n,t):void 0}function T3(n,t,e){return n instanceof kr?r6(n,t):n instanceof Vr?s6(n,t):e}function n6(n,t){return n instanceof xr?On(t)?t:{integerValue:0}:null}class js extends Vo{}class kr extends Vo{constructor(t){super(),this.elements=t}}function r6(n,t){const e=i6(t);for(const r of n.elements)e.some((s=>Ee(s,r)))||e.push(r);return{arrayValue:{values:e}}}class Vr extends Vo{constructor(t){super(),this.elements=t}}function s6(n,t){let e=i6(t);for(const r of n.elements)e=e.filter((s=>!Ee(s,r)));return{arrayValue:{values:e}}}class F1 extends Vo{constructor(t,e){super(),this.serializer=t,this.Re=e}}class xr extends F1{}class uo extends F1{}class lo extends F1{}function Gl(n,t,e){if(!On(t))return n.Re;const r=e(ho(t),ho(n.Re));return Ne(t)&&Ne(n.Re)?M1(r):Do(n.serializer,r)}function ho(n){return _t(n.integerValue||n.doubleValue)}function i6(n){return Dr(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fo(n){return new t9(n,!0)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Bi=null;function h1(){return Bi===null?Bi=(function(){return 268435456+Math.round(2147483648*Math.random())})():Bi++,"0x"+Bi.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F9(n){return typeof n=="object"&&n!==null&&!!("nullValue"in n&&(n.nullValue===null||n.nullValue==="NULL_VALUE")||"booleanValue"in n&&(n.booleanValue===null||typeof n.booleanValue=="boolean")||"integerValue"in n&&(n.integerValue===null||typeof n.integerValue=="number"||typeof n.integerValue=="string")||"doubleValue"in n&&(n.doubleValue===null||typeof n.doubleValue=="number")||"timestampValue"in n&&(n.timestampValue===null||(function(e){return typeof e=="object"&&e!==null&&"seconds"in e&&(e.seconds===null||typeof e.seconds=="number"||typeof e.seconds=="string")&&"nanos"in e&&(e.nanos===null||typeof e.nanos=="number")})(n.timestampValue))||"stringValue"in n&&(n.stringValue===null||typeof n.stringValue=="string")||"bytesValue"in n&&(n.bytesValue===null||n.bytesValue instanceof Uint8Array)||"referenceValue"in n&&(n.referenceValue===null||typeof n.referenceValue=="string")||"geoPointValue"in n&&(n.geoPointValue===null||(function(e){return typeof e=="object"&&e!==null&&"latitude"in e&&(e.latitude===null||typeof e.latitude=="number")&&"longitude"in e&&(e.longitude===null||typeof e.longitude=="number")})(n.geoPointValue))||"arrayValue"in n&&(n.arrayValue===null||(function(e){return typeof e=="object"&&e!==null&&!(!("values"in e)||e.values!==null&&!Array.isArray(e.values))})(n.arrayValue))||"mapValue"in n&&(n.mapValue===null||(function(e){return typeof e=="object"&&e!==null&&!(!("fields"in e)||e.fields!==null&&!oi(e.fields))})(n.mapValue))||"fieldReferenceValue"in n&&(n.fieldReferenceValue===null||typeof n.fieldReferenceValue=="string")||"functionValue"in n&&(n.functionValue===null||(function(e){return typeof e=="object"&&e!==null&&!(!("name"in e)||e.name!==null&&typeof e.name!="string"||!("args"in e)||e.args!==null&&!Array.isArray(e.args))})(n.functionValue))||"pipelineValue"in n&&(n.pipelineValue===null||(function(e){return typeof e=="object"&&e!==null&&!(!("stages"in e)||e.stages!==null&&!Array.isArray(e.stages))})(n.pipelineValue)))}function V_(){return new z1("serverTimestamp")}function x_(...n){return new W1("arrayUnion",n)}function L_(...n){return new K1("arrayRemove",n)}function M_(n){return new Y1("increment",n)}function U9(n){return new re(n)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dm{constructor(t){this.zr=t}}function pm(n){const t=a9({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?po(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ff{constructor(t,e){this.d_={},this.overlays={},this.f_=new No(0),this.m_=!1,this.m_=!0,this.p_=new vm,this.referenceDelegate=t(this),this.g_=new Pm(this),this.indexManager=new gm,this.remoteDocumentCache=(function(s){return new Sm(s)})((r=>this.referenceDelegate.y_(r))),this.serializer=new dm(e),this.w_=new Im(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.m_=!1,Promise.resolve()}get started(){return this.m_}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Am,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let r=this.d_[t.toKey()];return r||(r=new Rm(e,this.referenceDelegate),this.d_[t.toKey()]=r),r}getGlobalsCache(){return this.p_}getTargetCache(){return this.g_}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.w_}runTransaction(t,e,r){B("MemoryPersistence","Starting transaction:",t);const s=new bm(this.f_.next());return this.referenceDelegate.b_(),r(s).next((i=>this.referenceDelegate.v_(s).next((()=>i)))).toPromise().then((i=>(s.raiseOnCommittedEvent(),i)))}S_(t,e){return x.or(Object.values(this.d_).map((r=>()=>r.containsKey(t,e))))}}class bm extends c3{constructor(t){super(),this.currentSequenceNumber=t}}class fc{constructor(t){this.persistence=t,this.D_=new hc,this.x_=null}static C_(t){return new fc(t)}get F_(){if(this.x_)return this.x_;throw G(60996)}addReference(t,e,r){return this.D_.addReference(r,e),this.F_.delete(r.toString()),x.resolve()}removeReference(t,e,r){return this.D_.removeReference(r,e),this.F_.add(r.toString()),x.resolve()}markPotentiallyOrphaned(t,e){return this.F_.add(e.toString()),x.resolve()}removeTarget(t,e){this.D_.s_(e.targetId).forEach((s=>this.F_.add(s.toString())));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(t,e.targetId).next((s=>{s.forEach((i=>this.F_.add(i.toString())))})).next((()=>r.removeTargetData(t,e)))}b_(){this.x_=new Set}v_(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return x.forEach(this.F_,(r=>{const s=z.fromPath(r);return this.O_(t,s).next((i=>{i||e.removeEntry(s,Y.min())}))})).next((()=>(this.x_=null,e.apply(t))))}updateLimboDocument(t,e){return this.O_(t,e).next((r=>{r?this.F_.delete(e.toString()):this.F_.add(e.toString())}))}y_(t){return 0}O_(t,e){return x.or([()=>x.resolve(this.D_.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.S_(t,e)])}}class yo{constructor(t,e){this.persistence=t,this.M_=new lr((r=>f3(r.path)),((r,s)=>r.isEqual(s))),this.garbageCollector=N9(this,e)}static C_(t,e){return new yo(t,e)}b_(){}v_(t){return x.resolve()}forEachTarget(t,e){return this.persistence.getTargetCache().forEachTarget(t,e)}lr(t){const e=this.Ls(t);return this.persistence.getTargetCache().getTargetCount(t).next((r=>e.next((s=>r+s))))}Ls(t){let e=0;return this.Er(t,(r=>{e++})).next((()=>e))}Er(t,e){return x.forEach(this.M_,((r,s)=>this.Us(t,r,s).next((i=>i?x.resolve():e(s)))))}removeTargets(t,e,r){return this.persistence.getTargetCache().removeTargets(t,e,r)}removeOrphanedDocuments(t,e){let r=0;const s=this.persistence.getRemoteDocumentCache(),i=s.newChangeBuffer();return s.P_(t,(o=>this.Us(t,o,e).next((c=>{c||(r++,i.removeEntry(o,Y.min()))})))).next((()=>i.apply(t))).next((()=>r))}markPotentiallyOrphaned(t,e){return this.M_.set(e,t.currentSequenceNumber),x.resolve()}removeTarget(t,e){const r=e.withSequenceNumber(t.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(t,r)}addReference(t,e,r){return this.M_.set(r,t.currentSequenceNumber),x.resolve()}removeReference(t,e,r){return this.M_.set(r,t.currentSequenceNumber),x.resolve()}updateLimboDocument(t,e){return this.M_.set(e,t.currentSequenceNumber),x.resolve()}y_(t){let e=t.key.toString().length;return t.isFoundDocument()&&(e+=Ki(t.data.value)),e}Us(t,e,r){return x.or([()=>this.persistence.S_(t,e),()=>this.persistence.getTargetCache().containsKey(t,e),()=>{const s=this.M_.get(e);return x.resolve(s!==void 0&&s>r)}])}getCacheSize(t){return this.persistence.getRemoteDocumentCache().getSize(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class To{constructor(t,e,r,s,i){this._firestore=t,this._userDataWriter=e,this._key=r,this._document=s,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new yt(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const t=new x8(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){var t;return((t=this._document)==null?void 0:t.data.clone().value.mapValue.fields)??void 0}get(t){if(this._document){const e=this._document.data.field(Dn("DocumentSnapshot.get",t));if(e!==null)return this._userDataWriter.convertValue(e)}}}class x8 extends To{data(){return super.data()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $8 extends B8{constructor(t,e){super(t,e),this._firestore=t}get(t){const e=wn(t,this._firestore),r=new Xo(this._firestore);return super.get(t).then((s=>new Sn(this._firestore,r,e._key,s._document,new Tr(!1,!1),e.converter)))}}function j_(n,t,e){n=de(n,Ue);const r={...F8,...e};(function(o){if(o.maxAttempts<1)throw new F(V.INVALID_ARGUMENT,"Max attempts must be at least 1")})(r);const s=_i(n);return k8(s,(i=>t(new $8(n,i))),r)}function G_(n){n=de(n,rn);const t=de(n.firestore,Ue),e=_i(t),r=new Xo(t);return Vf(n._query),O8(e,n._query).then((s=>new er(t,r,n,s)))}function z_(n,t,e){n=de(n,yt);const r=de(n.firestore,Ue),s=Zo(n.converter,t,e),i=zr(r);return yi(r,[Bo(i,"setDoc",n._key,s,n.converter!==null,e).toMutation(n._key,Rt.none())])}function W_(n,t,e,...r){n=de(n,yt);const s=de(n.firestore,Ue),i=zr(s);let o;return o=typeof(t=Tt(t))=="string"||t instanceof Gr?X1(i,"updateDoc",n._key,t,e,r):Q1(i,"updateDoc",n._key,t),yi(s,[o.toMutation(n._key,Rt.exists(!0))])}function K_(n){return yi(de(n.firestore,Ue),[new hi(n._key,Rt.none())])}function Y_(n,t){const e=de(n.firestore,Ue),r=D9(n),s=Zo(n.converter,t),i=zr(n.firestore);return yi(e,[Bo(i,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Rt.exists(!1))]).then((()=>r))}function Q_(n,...t){var h,p,m;n=Tt(n);let e={includeMetadataChanges:!1,source:"default"},r=0;typeof t[r]!="object"||Ph(t[r])||(e=t[r++]);const s={includeMetadataChanges:e.includeMetadataChanges,source:e.source};if(Ph(t[r])){const T=t[r];t[r]=(h=T.next)==null?void 0:h.bind(T),t[r+1]=(p=T.error)==null?void 0:p.bind(T),t[r+2]=(m=T.complete)==null?void 0:m.bind(T)}let i,o,c;if(n instanceof yt)o=de(n.firestore,Ue),c=U1(n._key.path),i={next:T=>{t[r]&&t[r](q8(o,n,T))},error:t[r+1],complete:t[r+2]};else{const T=de(n,rn);o=de(T.firestore,Ue),c=T._query;const P=new Xo(o);i={next:O=>{t[r]&&t[r](new er(o,P,T,O))},error:t[r+1],complete:t[r+2]},Vf(n._query)}const u=_i(o);return N8(u,c,s,i)}function yi(n,t){const e=_i(n);return D8(e,t)}function q8(n,t,e){const r=e.docs.get(t._key),s=new Xo(n);return new Sn(n,s,t._key,r,new Tr(e.hasPendingWrites,e.fromCache),t.converter)}function X_(n){return n=de(n,Ue),_i(n),new U8(n,(t=>yi(n,t)))}(function(t,e=!0){z4(Ur),Ve(new ve("firestore",((r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new Ue(new Y4(r.getProvider("auth-internal")),new J4(o,r.getProvider("app-check-internal")),_3(o,s),o);return i={useFetchStreams:e,...i},c._setSettings(i),c}),"PUBLIC").setMultipleInstances(!0)),_e(Sh,Ch,t),_e(Sh,Ch,"esm2020")})();const Lf="@firebase/installations",Nc="0.6.22";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
